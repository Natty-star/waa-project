...
import edu.miu.notification.DTO.LogObject;
...
public class EmailTemplate {
    ...
    public  String orderCreatedEmailTemplate(NotificationRequest req ) {
        ...
        return "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "    <p style=\"font-size: 14px; line-height: 240%;\"><span style=\"color: #236fa1; font-size: 14px; line-height: 33.6px;\"><strong><span style=\"font-size: 24px; line-height: 57.6px;\"><span style=\"line-height: 48px; font-family: helvetica, sans-serif; font-size: 20px;\">"+ req.getPropertyType()+"</span></span></strong></span></p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "<div>\n" +
                "<div>\n" +
                "<div><strong>"+ req.getCustomerEmail()+" Booking Request </strong></div>\n" +
                "</div>\n" +
                "</div>\n" +
                "</div>\n" +
                "</div>\n" +
                ...
                "    <p style=\"font-size: 14px; line-height: 190%;\"><span style=\"font-size: 18px; line-height: 34.2px;\"><strong><span style=\"line-height: 34.2px; font-size: 18px;\">Dear  "+ req.getOwnerName()+",</span></strong></span></p>\n" +
                "<p style=\"font-size: 14px; line-height: 190%;\"><span style=\"font-size: 16px; line-height: 30.4px;\">"+req.getCustomerName() +" has placed an order for your property from "+ req.getStartDate() +" to " + req.getEndDate()+ "\n</span></p>\n" +
    ...
    public  String orderCanceledEmailTemplate(NotificationRequest req ) {
        ...
        return "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "  <div style=\"color: #4b4a4a; line-height: 190%; text-align: left; word-wrap: break-word;\">\n" +
                "    <p style=\"font-size: 14px; line-height: 190%;\"><span style=\"font-size: 18px; line-height: 34.2px;\"><strong><span style=\"line-height: 34.2px; font-size: 18px;\">Dear  "+ req.getOwnerName()+",</span></strong></span></p>\n" +
                "<p style=\"font-size: 14px; line-height: 190%;\"><span style=\"font-size: 16px; line-height: 30.4px;\">"+req.getCustomerName() +" has canceled the  order for your property "+"<strong>"+req.getPropertyType()+"</strong>, "+  req.getPropertyTitle()+ ".\n</span></p>\n" +
                "<div><strong>Property Management </strong></div>\n"+
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
    ...
    public  String orderApprovedEmailTemplate(NotificationRequest req ) {
        ...
        return "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "<div>\n" +
                "<div>\n" +
                "<div><strong>"+ req.getPropertyTitle()+" Booking Request </strong></div>\n" +
                "</div>\n" +
                "</div>\n" +
                "</div>\n" +
                "</div>\n" +
                ...
                "        \n" +
                "  <div style=\"color: #4b4a4a; line-height: 190%; text-align: left; word-wrap: break-word;\">\n" +
                "    <p style=\"font-size: 14px; line-height: 190%;\"><span style=\"font-size: 18px; line-height: 34.2px;\"><strong><span style=\"line-height: 34.2px; font-size: 18px;\">Dear  "+ req.getCustomerName()+",</span></strong></span></p>\n" +
                "<p style=\"font-size: 14px; line-height: 190%;\"><span style=\"font-size: 16px; line-height: 30.4px;\">Congratulations your order for "+ req.getPropertyType() +", "+req.getPropertyTitle() +" has been approved." +
    ...
    public  String orderDeclinedEmailTemplate(NotificationRequest req ) {
        ...
        return "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "  <div style=\"color: #4b4a4a; line-height: 190%; text-align: left; word-wrap: break-word;\">\n" +
                "    <p style=\"font-size: 14px; line-height: 190%;\"><span style=\"font-size: 18px; line-height: 34.2px;\"><strong><span style=\"line-height: 34.2px; font-size: 18px;\">Dear  "+ req.getCustomerName()+",</span></strong></span></p>\n" +
                "<p style=\"font-size: 14px; line-height: 190%;\"><span style=\"font-size: 16px; line-height: 30.4px;\">Sorry to inform you order for "+ req.getPropertyType() +", "+req.getPropertyTitle() +" has been declined." +
                "<div><strong>Property Management </strong></div>\n"+
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
